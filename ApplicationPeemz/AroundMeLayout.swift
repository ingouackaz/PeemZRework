...
struct AroundMeLayoutConstants {
    struct Cell {
...
class AroundMeLayout: UICollectionViewLayout {
    ...
    override func prepareLayout() {
        ...
        // Mettre la bonne longueur d'écran
        collectionView?.frame = CGRect(x: 0, y: 34, width: 400, height: 800 - 34)
